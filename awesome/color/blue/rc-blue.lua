...
--battery2
sysmon.widget.battery2 = redflat.widget.sysmon(
...
sysmon.buttons.network = awful.util.table.join(
	awful.button({ }, 1, function() os.execute("rofi-network") end)
)
	...
	function(s)
		...
		s.panel:setup {
			...
			{ -- right widgets
				...
				separator,
				env.wrapper(sysmon.widget.network, "network",sysmon.buttons.network),
				separator,
                ...
                separator,
				env.wrapper(sysmon.widget.battery2, "battery2"),
                separator,
			},
		}
	end
