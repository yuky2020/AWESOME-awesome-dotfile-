...
function hotkeys:init(args)
	...
	self.raw.root = {
		{
			{ env.mod }, "d", function()awful.spawn("rofi-appsmenu") end ,
			{ description = "Show rofi app  helper", group = "Main" }
		},
		{
			{ env.mod }, "F1", function() redtip:show() end,
		...
		{
			{ env.mod, "Mod1" }, "space", function() awful.spawn("betterlockscreen -l") end,
			{ description = "Beautifull system lock", group = "Actions" }
		},
		{
